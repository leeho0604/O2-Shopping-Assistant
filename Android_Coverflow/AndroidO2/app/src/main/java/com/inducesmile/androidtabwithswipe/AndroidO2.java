...
public class AndroidO2 extends Activity {
        ...
        try {
            ...
            if(namelist.isEmpty())
                ...
                if(imagelist.size() == 3) {
                    ...
                    String path = Environment.getDataDirectory().getAbsolutePath();
                    path += "/data/com.example.beacon/files/" + locallist.get(0);
                    String path2 = Environment.getDataDirectory().getAbsolutePath();
                    path2 += "/data/com.example.beacon/files/" + locallist.get(1);
                    String path3 = Environment.getDataDirectory().getAbsolutePath();
                    path3 += "/data/com.example.beacon/files/" + locallist.get(2);
                    String path4 = Environment.getDataDirectory().getAbsolutePath();
                    path4 += "/data/com.example.beacon/files/" + locallist.get(3);
                    if (new File(path).exists()) {
                        Toast.makeText(this, "bitmap is exist", Toast.LENGTH_SHORT).show();
                        mImage.setImageBitmap(BitmapFactory.decodeFile(path));
                    }
                ...
                /*for(int i = 0; i <= imagelist.size(); i++) {
                    ...
                    String path = Environment.getDataDirectory().getAbsolutePath() + "/data/com.example.beacon/files/";
    ...
    Handler mAfterDown = new Handler() {
        public void handleMessage(Message msg) {
            if (msg.obj != null) {
                String path = Environment.getDataDirectory().getAbsolutePath();
                path += "/data/com.example.beacon/files/" + (String)msg.obj;
                switch(index) {
                    case 1:
                        mImage.setImageBitmap(BitmapFactory.decodeFile(path));
                        break;
