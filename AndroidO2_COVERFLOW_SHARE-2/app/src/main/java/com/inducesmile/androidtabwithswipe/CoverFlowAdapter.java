...
public class CoverFlowAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder = (ViewHolder) rowView.getTag();//tag ViewHolder instance onto rowView

		Log.d("CoverFlowAdapter", position + " " + mData.size());
		holder.text.setText(mData.get(position).titleResId);
		holder.image.setImageBitmap(mData.get(position).imageResId);
